      ...
      <article class="light-bg infos" id="contact">
        <div class="text-box left">
          ...
          <motion.div
            ...
            :whileInView="{ scale: 1, opacity: 1, transition: { duration: 0.3, type: 'tween', ease: 'easeOut' } }"
            :viewport="{ once: true }"
          >
          ...
          <motion.div
            ...
            :initial="{ scale: 0.95, opacity: 0 }"
            :whileInView="{ scale: 1, opacity: 1, transition: { duration: 0.3, delay: 0.05, type: 'tween', ease: 'easeOut' } }"
            :viewport="{ once: true }"
          >
        ...
        <div class="text-box right">
          ...
          <motion.div
            ...
            :initial="{ scale: 0.95, opacity: 0 }"
            :whileInView="{ scale: 1, opacity: 1, transition: { duration: 0.3, delay: 0.1, type: 'tween', ease: 'easeOut' } }"
            :viewport="{ once: true }"
          >
            <ul>
              <li>
          ...
          <motion.div
            ...
            :initial="{ scale: 0.95, opacity: 0 }"
            :whileInView="{ scale: 1, opacity: 1, transition: { duration: 0.3, delay: 0.15, type: 'tween', ease: 'easeOut' } }"
            :viewport="{ once: true }"
          >
            <div class="skill">
